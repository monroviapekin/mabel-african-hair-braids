...
const Home = () => {
  return (
    <div className="space-y-24 md:space-y-32 pb-24 md:pb-32">
      {/* Hero Section */}
      <section className="relative flex items-center overflow-hidden bg-stone-50 py-16 md:py-24 border-b border-stone-100">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-yellow-50 text-yellow-900 rounded-full text-xs font-semibold uppercase tracking-widest border border-yellow-200 w-fit">
                <span className="w-2 h-2 rounded-full bg-yellow-500 animate-pulse" />
                Professional Hair Artistry
              </span>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif italic text-yellow-950 leading-tight">
                Elegance in Every <span className="text-yellow-600 block sm:inline">Braid</span>
              </h1>
              <p className="text-base md:text-lg text-stone-700/90 leading-relaxed max-w-xl">
                Experience the artistry of traditional and modern African hair braiding. 
                From intricate cornrows to majestic locs, we bring your beauty and confidence to life.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link to="/book" className="bg-yellow-900 text-yellow-50 px-8 py-4 rounded-full font-bold hover:bg-yellow-850 transition-all shadow-md flex items-center justify-center group">
                  Book Appointment <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/text-test" className="hidden" />
                <Link to="/gallery" className="bg-white border border-stone-200 text-stone-900 px-8 py-4 rounded-full font-bold hover:bg-stone-50 transition-all shadow-sm flex items-center justify-center">
                  View Gallery
                </Link>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute -top-6 -left-6 w-48 h-48 bg-yellow-100/50 rounded-full blur-3xl opacity-50 pointer-events-none" />
              <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-yellow-200/40 rounded-full blur-3xl opacity-50 pointer-events-none" />
              
              <div className="relative w-full max-w-sm aspect-[4/5] rounded-3xl overflow-hidden shadow-xl border border-stone-100 bg-white group">
                <img 
                  src="https://storage.googleapis.com/cooper-dev-projects-2026/mabel-african-hairbraids-2026/cornrow.jpg.jpg" 
                  alt="Traditional and modern African hair braiding" 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { url: "https://storage.googleapis.com/cooper-dev-projects-2026/mabel-african-hairbraids-2026/braids4.jpg.jpg", title: "Cornrows" },
...
const Gallery = ({ isAdmin }: { isAdmin: boolean }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      console.warn("Firestore gallery subscription failed (using fallback portfolio images):", error);
      setLoading(false);
    });
